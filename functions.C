...
double Bp3likelihood::sadgradient(const bool check, const bool outputmtz)
{
  ...
  Tsadgradient.stop(tag);


  fprintf(stderr, " <<<<<<<<<< xtal.maxselref= %d  sadweight.size()= %d\n", xtal.maxselref,
      (int)sadweight.size());
  tag = Tsadgradient.start("part2");
  for (unsigned r                 = 0; r < xtal.maxselref; r++)
  {
    std::string tag1;

    tag1 = Tsadgradient.start("part2::01");
    // Default value for columns to be written out is MNF
    ...
    Tsadgradient.stop(tag1);

    tag1 = Tsadgradient.start("part2::02");
    double eps((double) xtal.epsilon[r]);
    ...
    if (counts                    > 1)
    {
      Tsadgradient.start("counts");
      tag1 = Tsadgradient.start("part2::03");
      ...
      tag1 = Tsadgradient.record(tag1, "part2::04");
      ...
      tag1 = Tsadgradient.record(tag1, "part2::05");
      ...
      if (updatesigmah)
      {
        tag1 = Tsadgradient.start("part2::updatesigmah");
      ...
      if (!filter)
      {
        tag1 = Tsadgradient.start("part2::filter");
      ...
      {
        tag1 = Tsadgradient.start("part2::10");
      ...
      {
        tag1 = Tsadgradient.start("part2::11");
      ...
      Tsadgradient.stop("counts");
    }

    else if (outputmtz && (xtal.sf[d].usem(r) || xtal.sf[d].usep(r)) )
    {
      tag1 = Tsadgradient.start("part2::20");
